...
public class PartyManager
{
    ...
    public List<EntityPlayerMP> getOnlineTeammates(EntityPlayerMP player)
    {
        ...
        List<EntityPlayerMP> teammates = new ArrayList<>();
        ...
        teammates.sort((first, second) -> Double.compare(player.getDistanceSq(first), player.getDistanceSq(second)));
        return teammates;
    }
    ...
    public static String getPlayerNameKey(EntityPlayerMP player)
    {
